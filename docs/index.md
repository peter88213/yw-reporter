...
[Download the latest release (version 1.3.2)](https://raw.githubusercontent.com/peter88213/yw-reporter/main/dist/yw-reporter_v1.3.2.zip)

- Unzip the downloaded zipfile "yw-reporter_v1.3.2.zip" into a new folder.
