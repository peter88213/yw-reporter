...
[Download the latest release (version 2.0.1)](https://raw.githubusercontent.com/peter88213/yw-reporter/main/dist/yw-reporter_v2.0.1.zip)

- Unzip the downloaded zipfile "yw-reporter_v2.0.1.zip" into a new folder.
