...
[Download the latest release (version 1.7.6)](https://raw.githubusercontent.com/peter88213/yw-reporter/main/dist/yw-reporter_v1.7.6.zip)

- Unzip the downloaded zipfile "yw-reporter_v1.7.6.zip" into a new folder.
