...
[Download the latest release (version 1.7.4)](https://raw.githubusercontent.com/peter88213/yw-reporter/main/dist/yw-reporter_v1.7.4.zip)

- Unzip the downloaded zipfile "yw-reporter_v1.7.4.zip" into a new folder.
