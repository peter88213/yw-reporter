...
[Download the latest release (version 2.2.7)](https://raw.githubusercontent.com/peter88213/yw-reporter/main/dist/yw-reporter_v2.2.7.zip)

- Unzip the downloaded zipfile "yw-reporter_v2.2.7.zip" into a new folder.
